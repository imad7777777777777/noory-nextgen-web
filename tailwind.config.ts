  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "amber-pastel": "hsl(var(--color-amber-pastel))",
        "emerald-pastel": "hsl(var(--color-emerald-pastel))",
        "rose-pastel": "hsl(var(--color-rose-pastel))",
        "sky-pastel": "hsl(var(--color-sky-pastel))",
        sidebar: {
